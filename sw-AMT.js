// AMT 알림 Service Worker v20260429-v24
const CACHE = 'amt-v20260429-v24';
const APP_ROOT = '/AMT';
const ASSETS = [
  APP_ROOT + '/',
  APP_ROOT + '/index-AMT.html',
  APP_ROOT + '/orders-admin-AMT.html',
  ...
  if(isHtml) {
    event.respondWith((async () => {
      try {
        ...
        return (await caches.match(event.request)) || (await caches.match(APP_ROOT + '/index-AMT.html'));
      }
    })());
    return;
  }
...
self.addEventListener('notificationclick', event => {
  ...
  event.waitUntil((async () => {
    ...
    if(clients.openWindow) return clients.openWindow(APP_ROOT + '/index-AMT.html');
  })());
});
